...
public class RegistryOpenApiFilter implements OASFilter {
    ...
    private static final Logger LOG = Logger.getLogger(RegistryOpenApiFilter.class);

    @Override
    public void filterOpenAPI(OpenAPI openAPI) {
        debug(LOG, () -> "Generating OpenAPI document...");
    ...
    private Schema schemaForJsonSchema() {
        debug(LOG, () -> "Converting the active JSON schema to OpenAPI schema...");
